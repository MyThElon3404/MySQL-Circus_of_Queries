-- QUESTION : 1
-- 1. Write a query that calculates the total viewership for laptops and mobile devices, 
...
select 
	sum(case when device_type='tablet' or device_type='phone'
		then viewership_count end) as mobile_views,
	sum(case when device_type='laptop'
		then viewership_count end) as laptop_views
from viewership;
